...
import {
  Compass, HeartHandshake, Workflow, ShieldCheck, ArrowRight, CheckCircle2,
  BadgeCheck, Award, Sun, Battery, Zap, Gauge,
...
const About = () => {
  ...
  return (
    <SiteLayout>
      ...
      {/* Partner Network — full content from the old Partners page */}
      <section id="partners" className="py-20 lg:py-24 scroll-mt-24">
        <div className="container-tight max-w-3xl">
          ...
          <p className="mt-5 text-navy-soft text-lg leading-relaxed">
            Clean Energy Gurus works with a national network of MCS, OZEV and manufacturer-accredited installation partners. Every partner is continually assessed against our quality standards, so customers get one point of accountability from survey to aftercare.
          </p>
        </div>
      </section>
