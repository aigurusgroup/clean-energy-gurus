            ...
            <div className="relative grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-5 text-white/75 text-lg leading-relaxed max-w-md">
                  Tell us a little about your home and energy use. We'll respond
                  within one business day with a clear, no-pressure path forward.
                </p>
                <div className="mt-8 flex items-center gap-3 text-sm text-white/70">
                  <ShieldCheck className="h-5 w-5 text-electric" /> MCS-certified · OZEV partner network
                </div>
              </div>
